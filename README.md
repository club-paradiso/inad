...
- Docs: `AGENTS.md` (working rules — `CLAUDE.md`와 `GEMINI.md`는 이 파일을 가리킵니다), `docs/architecture.md`, `docs/design-system.md`, `docs/legal-baseline.md`, `docs/qa-v7.md`, `RELEASE_NOTES_v7.0.md`
